# Corneal Endothelial Cells — Verified Source Records

Index of patent/application source records verified against Google Patents
(accessed via r.jina.ai reader proxy, since direct fetches to
patents.google.com, Espacenet, and WIPO PatentScope were all blocked/503
...
|---|---|---|---|---|---|
| US10501725B2 | Method for producing therapeutic corneal endothelial substitute cell sphere | Keio University | Active | US | [US-10501725-B2.md](US-10501725-B2.md) |
| US20230210864A1 | Agent for promoting corneal endothelial cell adhesion | Senju Pharmaceutical | Pending | US | [US-2023-0210864-A1.md](US-2023-0210864-A1.md) |
| US10017735B2 | Cell culture of corneal endothelial cells | Singapore Health Services | Active | US | [US-10017735-B2.md](US-10017735-B2.md) |
| US10174284B2 | Medium for culturing corneal endothelial cells (MSC conditioned medium) | JCR Pharmaceuticals / Doshisha / Kyoto PUC | Active | US | [US-10174284-B2.md](US-10174284-B2.md) |
| US11633477B2 | Treatment of cornea using laminin | Senju / Doshisha / Kyoto PUC | Active | US | [US-11633477-B2.md](US-11633477-B2.md) |
| EP3213762B1 | Novel treatment of cornea using laminin | Senju / Doshisha / Kyoto PUC | Active | EP | [EP-3213762-B1.md](EP-3213762-B1.md) |
| US9347042B2 | Method for producing corneal endothelial cell | Keio University | Active | US | [US-9347042-B2.md](US-9347042-B2.md) |
| US11445723B2 | Method and container for preserving corneal endothelial cells | The Doshisha | Active | US | [US-11445723-B2.md](US-11445723-B2.md) |
| US12550891B2 | Storage method of human corneal endothelial cells/precursor cells | Kyoto PUC | Active | US | [US-12550891-B2.md](US-12550891-B2.md) |
| US20250000083A1 | Cryopreservation preparation for corneal endothelial cells | Doshisha / Actualeyes | Pending | US | [US-2025-0000083-A1.md](US-2025-0000083-A1.md) |
| EP4431596A4 | Cryopreservation preparation for corneal endothelial cells (EP) | Doshisha / Actualeyes | Pending | EP | [EP-4431596-A4.md](EP-4431596-A4.md) |
...
| WO2014038639A1 — Medium for culturing corneal endothelial cells (MSC conditioned medium) | **Superseded/duplicate** — same family as US10174284B2, which is included as the verified granted US member. |
| WO2015015655A1 — Fuchs' corneal endothelial dystrophy immortalized cell line and preparation method | **Outside date range.** Filed ~2013/2014, published 2015 — before the 2016-01-01 scope cutoff on both filing and publication. Not independently fetched/verified beyond search snippet; excluded on date grounds. |
| EP1675944B1 — Human corneal endothelial cells and methods of obtaining and culturing cells for corneal cell transplantation | **Outside date range** (originally filed/published mid-2000s, well before 2016). Not independently fetched; excluded on date grounds. |
| US20120288482A1 — Therapeutic agent (Y-39983) for corneal endothelial dysfunction | **Outside date range** (filed pre-2016 based on application number/publication year) and appears to be a small-molecule therapeutic rather than a cell-therapy/culture claim. Not independently fetched; excluded. |
| WO2017214022A1 — Method for assessing corneal tissue quality and endothelial cell density and morphology | **Diagnostic/imaging-only**, no cell-therapy or culture-method claim content apparent from title/snippet — excluded per exclusion criteria. Not independently fetched for full verification. |
| US12150712 — Corneal endothelial cell imaging apparatus, method of controlling same, and recording medium | **Device/diagnostic-only** (imaging apparatus) — excluded per exclusion criteria. Not independently fetched. |
| US11382904 — Therapeutic drug for diseases related to endoplasmic reticulum cell death in corneal endothelium | **Likely out of technology scope** (small-molecule/ER-stress drug, not a cell-therapy product or culture method) based on title. Not independently fetched/verified; excluded without full verification rather than included on an unverified basis. |
| US20160271224A1 — Methods of reducing corneal endothelial cell loss (VIP peptide) | **Likely out of technology scope** (peptide drug, not a cultured-cell therapy product) based on title/snippet. Not independently fetched/verified; excluded without full verification. |
| CN112522179A — Separation culture method of corneal endothelial cells | **Out of jurisdiction** — China is not one of the searched/verified jurisdictions (US, EP, WO only) per scope. |

## Method note

Direct HTTPS access to patents.google.com, worldwide.espacenet.com, and
patentscope.wipo.int returned 503/403 errors from within this environment
(general internet access and freepatentsonline.com were reachable). All
Google Patents bibliographic and legal-status data above was retrieved by
fetching the same patents.google.com URLs through the r.jina.ai reader
proxy (`https://r.jina.ai/<google-patents-url>`), which returns the
server-rendered page content. Each record's Source URL field points to the
canonical patents.google.com page for independent re-verification.
